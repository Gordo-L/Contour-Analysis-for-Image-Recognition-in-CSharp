...
namespace ContourAnalysis
{
    ...
    /// Contour 轮廓
    /// </summary>
    /// <remarks>Vector of complex numbers 复数向量</remarks>
    [Serializable]
    public class Contour
    {
        ...
        /// <summary>
        /// Returns R^2 of difference of norms 返回标准差R^2
        /// </summary>
        /// <param name="c"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Intercorrelcation function (ICF) 互相关函数
        /// </summary>
        ...
        /// <summary>
        /// Normalized Scalar Product 标准化标准积
        /// </summary>
        ...
        /// <summary>
        /// Changes length of contour (equalization) 改变轮廓长度（均衡化）
        /// </summary>
